...
# Caricare i dati
file_path = "resultsSGDExtension20.xlsx"  # Modifica il percorso se necessario
...
plt.tight_layout()
plt.savefig("resultsSGDExtension20-1.png")  # Save the figure
plt.show()
...
plt.savefig("resultsSGDExtension20-2.png")  # Save the figure
plt.show()
...
plt.tight_layout()
plt.savefig("resultsSGDExtension20-3.png")  # Save the figure
plt.show()
...
plt.savefig("resultsSGDExtension20-4.png")  # Save the figure
plt.show()
